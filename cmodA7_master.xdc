...
set_false_path -from [get_cells -hierarchical -filter {NAME =~ *ram_rst*}]
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33 DRIVE 8} [get_ports i2s_mclk]
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33 DRIVE 8} [get_ports i2s_lrclk]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33 DRIVE 8} [get_ports i2s_bclk]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33 DRIVE 8} [get_ports i2s_dacsd]

set_property CFGBVS VCCO [current_design]
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { i2s_mclk }]; #IO_L5P_T0_D06_14 Sch=ja[7]
#set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS33 } [get_ports { i2s_lrclk }]; #IO_L4P_T0_D04_14 Sch=ja[8]
#set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { i2s_bclk }]; #IO_L6N_T0_D08_VREF_14 Sch=ja[9]
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { i2s_adcsd }]; #IO_L8N_T1_D12_14 Sch=ja[10]
